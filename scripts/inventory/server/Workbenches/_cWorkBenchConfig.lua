WorkBenchConfig = 
{
    locations = 
    {
        {position = Vector3(4755.66, 572.224, 13219.67), angle = Angle()}, -- South
    ...
    max_items_at_once = 5, -- How many items can be put in the workbench at once
    maximum_durability = 5, -- Max durability is 5x normal
    durability_bonus = 0.1, -- x% durability bonus upon combining two items
