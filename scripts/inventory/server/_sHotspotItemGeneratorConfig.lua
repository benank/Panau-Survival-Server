    ...
    ["CapeCarnivalHotspot"] = {
        ...
        [Lootbox.Types.Level3] = 
        {
            ...
            ["AMMO"] = 
            {
                ...
                items = 
                {
                    ["Shotgun Ammo"] = {rarity = 0.2, min = 6, max = 10},
                    ["Assault Ammo"] = {rarity = 0.2, min = 15, max = 30},
                    ["Sniper Ammo"] = {rarity = 0.2, min = 1, max = 2},
                    ["GrLauncher Ammo"] = {rarity = 0.2, min = 1, max = 2},
                    ["Machine Gun Ammo"] = {rarity = 0.2, min = 10, max = 15},
                }
            },
            ["ARMOUR"] = 
            {
                ...
                items = 
                {
                    ["Police Helmet"] = {rarity = 0.2, min = 1, max = 1},
                    ["Military Helmet"] = {rarity = 0.8, min = 1, max = 1},
                }
            },
            ["EXPLOSIVE"] = 
            {
                ...
                items = 
                {
                    ["Toxic Grenade"] = {rarity = 0.2, min = 2, max = 3},
                    ["Mine"] = {rarity = 0.3, min = 2, max = 3},
                    ["Claymore"] = {rarity = 0.25, min = 2, max = 2},
                    ["Molotov"] = {rarity = 0.15, min = 2, max = 3},
                    ["Impulse Grenade"] = {rarity = 0.1, min = 1, max = 3},
                }
            },
            ["GEAR"] = 
            ...
            ["HEALTH"] = 
            {
                ...
                items = 
                {
                    ["Healthpack"] = {rarity = 1, min = 1, max = 2},
                }
            },
            ["TOOL"] = 
            {
            ...
            ["WEAPON"] = 
            {
                ...
                items = 
                {
                    ["Sawn-Off Shotgun"] = {rarity = 0.1, min = 1, max = 1},
                    ["SMG"] = {rarity = 0.1, min = 1, max = 1},
                    ["Shotgun"] = {rarity = 0.3, min = 1, max = 1},
                    ["Assault Rifle"] = {rarity = 0.3, min = 1, max = 1},
                    ["Sniper Rifle"] = {rarity = 0.2, min = 1, max = 1},
                }
            },
        ...
        [Lootbox.Types.Level4] = 
        {
            ...
            ["EXPLOSIVE"] = 
            {
                ...
                items = 
                {
                    ["Mine"] = {rarity = 0.258, min = 2, max = 3},
                    ["Claymore"] = {rarity = 0.122, min = 2, max = 3},
                    ["Impulse Grenade"] = {rarity = 0.1, min = 3, max = 5},
                    ["Cluster Grenade"] = {rarity = 0.25, min = 2, max = 4},
                    ["C4"] = {rarity = 0.27, min = 1, max = 1},
                }
            ...
            ["WEAPON"] = 
            {
                ...
                items = 
                {
                    ["Shotgun"] = {rarity = 0.10, min = 1, max = 1},
                    ["Assault Rifle"] = {rarity = 0.4, min = 1, max = 1},
                    ["Sniper Rifle"] = {rarity = 0.2, min = 1, max = 1},
                    ["Grenade Launcher"] = {rarity = 0.15, min = 1, max = 1},
                    ["Machine Gun"] = {rarity = 0.1, min = 1, max = 1},
                    ["Rocket Launcher"] = {rarity = 0.05, min = 1, max = 1},
                }
            }
        },
    },
    ["LostIslandCenterHotspot"] = {
        [Lootbox.Types.AirdropLevel2] = 
        {
            ["WARP_CORE"] = 
            {
                ...
                items = 
                {
                    ["Warp Core"] = {rarity = 1, min = 1, max = 1},
                }
            },
            ["LOCKPICK"] = 
            {
        ...
        [Lootbox.Types.AirdropLevel3] = 
        {
            ["WARP_CORE"] = 
            {
                ...
                items = 
                {
                    ["Warp Core"] = {rarity = 1, min = 2, max = 3},
                }
            },
            ["LOCKPICK"] = 
            {
