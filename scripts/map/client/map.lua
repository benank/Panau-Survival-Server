...
function Map:DrawRedAreas()

    local color = Color.Red
    local alpha = 75

    for _, area in pairs(BlacklistedLandclaimAreas) do

        local pos = Map:WorldToScreen(area.pos)
        local size = area.size / 32768 * Render.Height * Map.Zoom
