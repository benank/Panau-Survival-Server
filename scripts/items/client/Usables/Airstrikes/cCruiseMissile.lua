class 'cCruiseMissile'

function cCruiseMissile:__init(args)
...
function cCruiseMissile:Initialize()
...
function cCruiseMissile:Strike()
...
function cCruiseMissile:Render(args)
...
function cCruiseMissile:ModuleUnload()
