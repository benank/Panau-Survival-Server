...
function WeaponDamage:__init()
    ...
    self.weapon_damages = {
        ...
        [WeaponEnum.GrenadeLauncher] =  {base = 0.10, v_mod = 1,     distance_falloff = 0,   falloff = function() return 1 end, radius = 5},
        [WeaponEnum.Revolver] =         {base = 0.09, v_mod = 0.05,  distance_falloff = 300, falloff = falloff_func},
        [WeaponEnum.RocketLauncher] =   {base = 0.15, v_mod = 1.5,   distance_falloff = 0,   falloff = function() return 1 end, radius = 7},
        [WeaponEnum.SMG] =              {base = 0.05, v_mod = 0.02,  distance_falloff = 100, falloff = falloff_func},
        ...
        [WeaponEnum.SawnOffShotgun] =   {base = 0.08, v_mod = 0.05,   distance_falloff = 80,  falloff = falloff_func},
        [WeaponEnum.Shotgun] =          {base = 0.08, v_mod = 0.05,   distance_falloff = 100, falloff = falloff_func},
        
        -- Vehicle Weapons
        [WeaponEnum.V_Minigun] =        {base = 0.02, v_mod = 0.1,   distance_falloff = 500, falloff = falloff_func},
        [WeaponEnum.V_Rockets] =        {base = 0.15, v_mod = 3,     distance_falloff = 0,   falloff = function() return 1 end, radius = 12},
        [WeaponEnum.V_Cannon] =         {base = 0.10, v_mod = 1.0,   distance_falloff = 0,   falloff = function() return 1 end, radius = 10},
        [WeaponEnum.V_MachineGun] =     {base = 0.07, v_mod = 0.2,   distance_falloff = 300, falloff = falloff_func}
    }
