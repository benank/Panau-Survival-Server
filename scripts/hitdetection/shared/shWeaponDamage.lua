...
function WeaponDamage:__init()
    ...
    self.weapon_damages = {
        ...
        -- Vehicle Weapons
        [WeaponEnum.V_Minigun] =        {base = 0.05, v_mod = 2,     distance_falloff = 500, falloff = falloff_func},
        [WeaponEnum.V_Rockets] =        {base = 0.30, v_mod = 2,     distance_falloff = 0,   falloff = function() return 1 end, radius = 12},
        [WeaponEnum.V_Cannon] =         {base = 0.10, v_mod = 3,     distance_falloff = 0,   falloff = function() return 1 end, radius = 6},
        [WeaponEnum.V_MachineGun] =     {base = 0.08, v_mod = 0.5,   distance_falloff = 300, falloff = falloff_func}
    }
