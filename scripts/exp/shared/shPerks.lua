ExpPerks = 
{
    ...
    {
        name = "Bandages",
        description = "Bandages take 25% less time to use",
        level_req = 5,
        perk_req = 0,
        cost = 1,
        id = 19,
    ...
    {
        name = "Inventory",
        description = "Adds 1 extra slot to your explosives category",
        level_req = 6,
        perk_req = 4,
        cost = 0,
        id = 20,
    ...
    {
        name = "SMG",
        description = "SMG now does 10% extra damage",
        level_req = 7,
        perk_req = 11,
        cost = 1,
        id = 23,
    ...
    {
        name = "Inventory",
        description = "Adds 1 extra slot to your supplies category",
        level_req = 9,
        perk_req = 20,
        cost = 0,
        id = 31,
    ...
    {
        name = "Grapplehook",
        description = "Grapplehook is now 25% faster",
        level_req = 9,
        perk_req = 0,
        cost = 1,
        id = 33,
    ...
    {
        name = "SMG",
        description = "SMG now does 15% extra damage",
        level_req = 9,
        perk_req = 23,
        cost = 2,
        id = 32,
    ...
    {
        name = "Arena",
        description = "Allows you to enter the Arena",
        level_req = 10,
        perk_req = 0,
        cost = 0,
        id = 38,
    ...
    {
        name = "Oxygen",
        description = "Decreases underwater oxygen consumption by 25%",
        level_req = 10,
        perk_req = 0,
        cost = 1,
        id = 39,
    ...
    {
        name = "HE Grenade",
        description = "HE Grenades now deal 10% extra damage",
        level_req = 10,
        perk_req = 0,
        cost = 1,
        id = 234,
    ...
    {
        name = "Bandages",
        description = "Bandages take 50% less time to use",
        level_req = 10,
        perk_req = 19,
        cost = 2,
        id = 36,
    ...
    {
        name = "Parachute",
        description = "Parachutes now have 10% extra durability",
        level_req = 11,
        perk_req = 0,
        cost = 1,
        id = 43,
    ...
    {
        name = "SMG",
        description = "SMG now does 20% extra damage",
        level_req = 11,
        perk_req = 32,
        cost = 2,
        id = 44,
    ...
    {
        name = "Inventory",
        description = "Adds 1 extra slot to your survival category",
        level_req = 12,
        perk_req = 31,
        cost = 0,
        id = 46,
    ...
    {
        name = "SMG",
        description = "SMG now does 25% extra damage",
        level_req = 13,
        perk_req = 44,
        cost = 3,
        id = 51,
    ...
    {
        name = "Shotgun",
        description = "Shotgun now does 10% extra damage",
        level_req = 15,
        perk_req = 41,
        cost = 1,
        id = 63,
    ...
    {
        name = "Healthpack",
        description = "Healthpacks take 25% less time to use",
        level_req = 15,
        perk_req = 0,
        cost = 3,
        id = 60,
    ...
    {
        name = "Assault Rifle",
        description = "Assault Rifle now does 10% extra damage",
        level_req = 17,
        perk_req = 40,
        cost = 1,
        id = 69,
    ...
    {
        name = "Workbench",
        description = "Workbenches now take 25% less time to combine items",
        level_req = 17,
        perk_req = 12,
        cost = 2,
        id = 70,
    ...
    {
        name = "Grapplehook",
        description = "Grapplehook is now 50% faster",
        level_req = 18,
        perk_req = 33,
        cost = 2,
        id = 73,
    ...
    {
        name = "HE Grenade",
        description = "HE Grenades now deal 20% extra damage",
        level_req = 20,
        perk_req = 234,
        cost = 1,
        id = 235,
    ...
    {
        name = "Shotgun",
        description = "Shotgun now does 15% extra damage",
        level_req = 20,
        perk_req = 63,
        cost = 2,
        id = 80,
    ...
    },
    {
        ...
        description = "LandClaim extensions now last 50% longer",
        level_req = 20,
        perk_req = 53,
        cost = 2,
        id = 82,
    ...
    {
        name = "Airdrop",
        description = "Gives you an extra 5 minutes warning before an incoming airdrop",
        level_req = 20,
        perk_req = 0,
        cost = 2,
        id = 84,
    ...
    {
        name = "Healthpack",
        description = "Healthpacks take 50% less time to use",
        level_req = 20,
        perk_req = 60,
        cost = 4,
        id = 85,
    ...
    {
        name = "Assault Rifle",
        description = "Assault Rifle now does 15% extra damage",
        level_req = 22,
        perk_req = 69,
        cost = 2,
        id = 88,
    ...
    {
        name = "Parachute",
        description = "Parachutes now have 25% extra durability",
        level_req = 22,
        perk_req = 43,
        cost = 2,
        id = 89,
    ...
    },
    {
        ...
        description = "Decreases hunger and thirst rate by 20%",
        level_req = 23,
        perk_req = 0,
        cost = 1,
        id = 90,
    ...
    {
        name = "EMP",
        description = "Choose: 10% extra range or 10% extra duration",
        level_req = 23,
        perk_req = 0,
        cost = 1,
        id = 239,
    ...
    {
        name = "Sniper Rifle",
        description = "Sniper Rifle now does 10% extra damage",
        level_req = 24,
        perk_req = 52,
        cost = 1,
        id = 96,
    ...
    {
        name = "Shotgun",
        description = "Shotgun now does 20% extra damage",
        level_req = 25,
        perk_req = 80,
        cost = 2,
        id = 98,
    ...
    {
        name = "Arena",
        description = "Allows you to teleport to the arena with the command /arena",
        level_req = 25,
        perk_req = 38,
        cost = 3,
        id = 101,
    ...
    },
    {
        ...
        description = "Your grapplehook will now snap to the nearest surface, even when you're not aiming directly at it",
        level_req = 25,
        perk_req = 0,
        cost = 5,
        id = 99,
    ...
    {
        name = "Workbench",
        description = "Workbenches now take 50% less time to combine items",
        level_req = 26,
        perk_req = 70,
        cost = 3,
        id = 106,
    ...
    {
        name = "Grenade Launcher",
        description = "Grenade Launcher now does 5% extra damage",
        level_req = 27,
        perk_req = 55,
        cost = 1,
        id = 109,
    ...
    {
        name = "Assault Rifle",
        description = "Assault Rifle now does 20% extra damage",
        level_req = 27,
        perk_req = 88,
        cost = 2,
        id = 111,
    ...
    {
        name = "Grapplehook",
        description = "Grapplehook is now 75% faster",
        level_req = 27,
        perk_req = 73,
        cost = 3,
        id = 110,
    ...
    {
        name = "HE Grenade",
        description = "HE Grenades now deal 30% extra damage",
        level_req = 30,
        perk_req = 235,
        cost = 2,
        id = 236,
    ...
    {
        name = "Shotgun",
        description = "Shotgun now does 25% extra damage",
        level_req = 30,
        perk_req = 98,
        cost = 3,
        id = 118,
    ...
    {
        name = "Assault Rifle",
        description = "Assault Rifle now does 25% extra damage",
        level_req = 32,
        perk_req = 111,
        cost = 3,
        id = 125,
    ...
    },
    {
        ...
        description = "Unlocks the /safezone command to teleport to the safezone, even if your respawn point is elsewhere",
        level_req = 33,
        perk_req = 0,
        cost = 3,
        id = 129,
    ...
    {
        name = "Parachute",
        description = "Parachutes now have 50% extra durability",
        level_req = 34,
        perk_req = 89,
        cost = 2,
        id = 130,
    ...
    {
        name = "Sniper Rifle",
        description = "Sniper Rifle now does 15% extra damage",
        level_req = 35,
        perk_req = 96,
        cost = 2,
        id = 134,
    ...
    {
        name = "Grapplehook",
        description = "Grapplehook is now 100% faster",
        level_req = 36,
        perk_req = 110,
        cost = 3,
        id = 233,
    ...
    {
        name = "Oxygen",
        description = "Decreases underwater oxygen consumption by 50%",
        level_req = 38,
        perk_req = 39,
        cost = 2,
        id = 139,
    ...
    {
        name = "Grenade Launcher",
        description = "Grenade Launcher now does 10% extra damage",
        level_req = 40,
        perk_req = 109,
        cost = 1,
        id = 149,
    ...
    {
        name = "HE Grenade",
        description = "HE Grenades now deal 40% extra damage",
        level_req = 40,
        perk_req = 236,
        cost = 2,
        id = 237,
    ...
    {
        name = "Inventory",
        description = "Unlocks one inventory slot that will be kept upon death",
        level_req = 40,
        perk_req = 0,
        cost = 3,
        id = 148,
    ...
    {
        name = "Building: LandClaim",
        description = "LandClaim extensions now last 75% longer",
        level_req = 41,
        perk_req = 82,
        cost = 3,
        id = 150,
    ...
    {
        name = "Parachute",
        description = "Parachutes now have 75% extra durability",
        level_req = 44,
        perk_req = 130,
        cost = 3,
        id = 156,
    ...
    {
        name = "Rocket Launcher",
        description = "Rocket Launcher now does 10% extra damage",
        level_req = 45,
        perk_req = 122,
        cost = 1,
        id = 160,
    ...
    {
        name = "Machine Gun",
        description = "Machine Gun now does 10% extra damage",
        level_req = 46,
        perk_req = 115,
        cost = 1,
        id = 162,
    ...
    {
        name = "Sniper Rifle",
        description = "Sniper Rifle now does 20% extra damage",
        level_req = 46,
        perk_req = 134,
        cost = 2,
        id = 161,
    ...
    {
        name = "Hunger and Thirst",
        description = "Decreases hunger and thirst rate by 40%",
        level_req = 47,
        perk_req = 90,
        cost = 2,
        id = 163,
    ...
    {
        name = "HE Grenade",
        description = "HE Grenades now deal 50% extra damage",
        level_req = 50,
        perk_req = 237,
        cost = 3,
        id = 238,
    ...
    {
        name = "Parachute",
        description = "Parachutes now have 100% extra durability",
        level_req = 55,
        perk_req = 156,
        cost = 4,
        id = 175,
    ...
    {
        name = "Grenade Launcher",
        description = "Grenade Launcher now does 15% extra damage",
        level_req = 57,
        perk_req = 149,
        cost = 2,
        id = 179,
    ...
    {
        name = "Sniper Rifle",
        description = "Sniper Rifle now does 25% extra damage",
        level_req = 57,
        perk_req = 161,
        cost = 3,
        id = 178,
    ...
    {
        name = "Building: LandClaim",
        description = "LandClaim extensions now last 100% longer",
        level_req = 59,
        perk_req = 150,
        cost = 4,
        id = 181,
    ...
    {
        name = "Rocket Launcher",
        description = "Rocket Launcher now does 15% extra damage",
        level_req = 61,
        perk_req = 160,
        cost = 2,
        id = 185,
    ...
    {
        name = "EVAC",
        description = "Adds 20% chance that your EVAC won't be consumed when called",
        level_req = 62,
        perk_req = 123,
        cost = 3,
        id = 186,
    ...
    {
        name = "Machine Gun",
        description = "Machine Gun now does 15% extra damage",
        level_req = 63,
        perk_req = 162,
        cost = 2,
        id = 188,
    ...
    {
        name = "Oxygen",
        description = "Decreases underwater oxygen consumption by 75%",
        level_req = 66,
        perk_req = 139,
        cost = 3,
        id = 193,
    ...
    {
        name = "Hunger and Thirst",
        description = "Decreases hunger and thirst rate by 60%",
        level_req = 71,
        perk_req = 163,
        cost = 3,
        id = 200,
    ...
    {
        name = "Grenade Launcher",
        description = "Grenade Launcher now does 20% extra damage",
        level_req = 74,
        perk_req = 179,
        cost = 2,
        id = 203,
    ...
    {
        name = "Rocket Launcher",
        description = "Rocket Launcher now does 20% extra damage",
        level_req = 77,
        perk_req = 185,
        cost = 2,
        id = 208,
    ...
    {
        name = "Machine Gun",
        description = "Machine Gun now does 20% extra damage",
        level_req = 81,
        perk_req = 188,
        cost = 2,
        id = 212,
    ...
    {
        name = "Grenade Launcher",
        description = "Grenade Launcher now does 25% extra damage",
        level_req = 91,
        perk_req = 203,
        cost = 3,
        id = 221,
    ...
    {
        name = "Rocket Launcher",
        description = "Rocket Launcher now does 25% extra damage",
        level_req = 93,
        perk_req = 208,
        cost = 3,
        id = 224,
    ...
    {
        name = "Hunger and Thirst",
        description = "Decreases hunger and thirst rate by 80%",
        level_req = 94,
        perk_req = 200,
        cost = 4,
        id = 225,
    ...
    {
        name = "Machine Gun",
        description = "Machine Gun now does 25% extra damage",
        level_req = 97,
        perk_req = 212,
        cost = 3,
        id = 229,
